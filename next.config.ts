      ...
      // Headers globales para todas las rutas
      {
        ...
        headers: [
          ...
          // Content Security Policy - Configurado para compatibilidad con proyecto
          {
            ...
            value: [
              "default-src 'self'",
              // Scripts: Next.js hydration + JSON-LD + Google OAuth
              // Vercel Live (solo en preview): https://vercel.live
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://vercel.live https://accounts.google.com https://*.google.com https://apis.google.com",
              ...
              "connect-src 'self' https://*.supabase.co https://api.openai.com https://*.upstash.io https://*.r2.dev https://vercel.live https://accounts.google.com https://*.googleapis.com https://*.google.com blob: data:",
              // Frames: PDFs de Supabase Storage y Cloudflare R2, Google OAuth
              // Vercel Live (solo en preview): iframe de feedback
              "frame-src 'self' blob: data: https://*.supabase.co https://*.r2.dev https://vercel.live https://accounts.google.com",
              // Otros
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self'",
