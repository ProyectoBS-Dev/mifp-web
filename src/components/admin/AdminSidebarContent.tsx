...
/**
 * Contenido puro de navegación admin, sin clases de visibilidad.
 * Se reutiliza tanto en desktop (via AdminSidebar) como en mobile (via AdminMobileSidebar).
 */
export const AdminSidebarContent = memo(function AdminSidebarContent() {
