	...
	theme: {
		extend: {
			...
			colors: {
				...
				// ═══════════════════════════════════════════════════════════════
				// VT - Vue Theme Official Brand Colors
				// Source: https://github.com/vuejs/theme/blob/main/src/core/styles/variables.css
				// ═══════════════════════════════════════════════════════════════
				vt: {
					// ─── Brand: Green (Primary) ───
					green: '#42b883',
					...
					// ─── Neutrals: White (Light mode backgrounds) ───
					white: '#ffffff',
					'white-soft': '#f9f9f9',
					'white-mute': '#f1f1f1',
					...
					// ─── Neutrals: Indigo (Light mode text) ───
					indigo: '#213547',
					'indigo-soft': '#476582',
					'indigo-light': '#aac8e4',
